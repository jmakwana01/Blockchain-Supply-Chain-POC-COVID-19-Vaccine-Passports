...
contract('ColdChain', (accounts) => {
  ...
  before(async()=>{
    ...
    this.defaultVaccineBatches = {
      ...
      2:{brand: this.VACCINE_BRANDS.Covisheld,manufacturer:this.defaultEntities.manufacturerB.id},
      ...
      9:{brand: this.VACCINE_BRANDS.Covisheld,manufacturer:this.defaultEntities.manufacturerA.id},
